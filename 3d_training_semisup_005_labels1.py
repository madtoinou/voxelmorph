...
vxm_model.save_weights("wght_3d_semisup_val_labels1_"+str(lambda_param)+".keras")

util.export_history(hist, "hist_3d_semisup_val_labels1_"+str(lambda_param)+".txt")
